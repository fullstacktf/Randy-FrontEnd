...
const DivIcon = styled.div<any>`
  ...
  svg > path,  
  rect {
    fill: ${props => props.active ? '#7df779' : '#FFF'};
  }
  &:hover:not(.isActive) {
      ...
      return (
        <DivIcon active={active}>
          <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.25 12.75C3.14543 12.75 2.25 13.6454 2.25 14.75V16.7891V18.25C2.25 19.3546 3.14543 20.25 4.25 20.25H7.75C8.85457 20.25 9.75 19.3546 9.75 18.25V14.75C9.75 14.6279 9.73905 14.5083 9.71808 14.3922L5.14652 19.6856L2.25 16.7891L3.17522 15.8638L5.07635 17.765L8.75973 13.5L9.70236 14.3141C9.50342 13.4191 8.70485 12.75 7.75 12.75H4.25Z" fill="#FFFFFF"/>
